...
import 'package:amlaky/searchFliter/ByPrice_estates.dart';
import 'package:amlaky/searchFliter/Bydate_cars.dart';
import 'package:flutter/material.dart';

Widget EstatesByPriceContainer(context) {
  return Container(
    ...
    child: ListView.builder(
        ...
        itemCount: estates_price_values.length,
        itemBuilder: (BuildContext context, int index) {
          var price = estates_price_values[index];
          var name = price[0];
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ByEstatesPrice( priceval, name),
                  ),
                );
              },
              child: Row(
