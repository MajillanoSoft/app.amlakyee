...
class CarsSearchIdPage extends SearchDelegate {
  CarsSearchIdPage()
      : super(searchFieldLabel: "أكتب رقم الإعلان الذي تبحث عنه ...");
  @override
  ...
  Widget buildSuggestions(BuildContext context) {
    if (query.isEmpty) {
      ...
      return FutureBuilder(
        future: CarsSearcbyIdhUrl(query),
